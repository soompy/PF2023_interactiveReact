        ...
        <>
            <div className="inner">
                <section className="article-view-header">                        
                        <h3 className="heading">주제 주제 주제 주제</h3>
                        
                        <div className="info-group">
                            <article className="item">
                                <ul className="infomation">                                    
                                  <li><FontAwesomeIcon icon={faUser} /><span className="show-for-sr"> 작성자</span> 닉닉넴</li>
                                  <li><FontAwesomeIcon icon={faClock} /> 2023.12.22 13:16</li>
                                  <li><FontAwesomeIcon icon={faComment} /> 댓글 0</li>
                                </ul>
                ...
                <section className="article-view-cont">
                    ...
                    <p>글 글글글 글 글글글 글 글글글 글 글글글글 글글글 글 글글글 글 글글글</p>
                    <p>글 글글글 글 글글글 글 글글글 글 글글글글 글글글 글 글글글 글 글글글</p>
                </section>
            </div>
        </>
